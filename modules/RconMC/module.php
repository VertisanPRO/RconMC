...
class RconMC_Module extends Module
{
    ...
    {
        try {
            DB::getInstance()->createTable("rcon_mc", " `id` int(11) NOT NULL AUTO_INCREMENT, `rcon_name` varchar(30) NOT NULL, `rcon_ip` varchar(30) NOT NULL, `rcon_port` int(11) NOT NULL, `rcon_pass` varchar(255) NOT NULL, PRIMARY KEY (`id`)");
        } catch (Exception $e) {
            // Error
        }
    }
