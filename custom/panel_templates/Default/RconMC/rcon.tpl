            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <section class="content">
                        ...
                        <h5 style="margin-block-end: 30px;"><i class="fa fa-terminal" aria-hidden="true">
                                {$CONSOLE}:</i>
                            {$SERVER_NAME}</h5>
                        {if count($CMD_BTN)}
                        ...
                        <section class="terminal-container terminal-fixed-top">
                            ...
                            <form action="" method="post">
                                <div class="input-group">
                                    ...
                                    <button type="button" onclick="cmdSend('input')"
            ...
            var test = $.ajax({
                ...
                success: function(resp) {
                    if (resp.status == 'error') {
                        $('#terminal').append('<p class="console"><span style="color: red;">' + resp
                            .error_status +
                            '</span></p>');
